...
TEST_IMAGES_DIR = os.getcwd() + "/tensor/test_images"
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            # if we were not aimread successfully open the image, continue with the next iteration of the for loop
            ...
            print(predictions[0][53])

            # # sort predictions from most confidence to least confidence
            pSorted = predictions[0].argsort()[-len(predictions[0]):][::-1]
            print(pSorted)
            ...
            #     # ifconfidencet (most likely) prediction, state what the object appears to be and show a % confidence to two decimal places
    ...
    tfFileWriter = tf.summary.FileWriter(os.getcwd() + '/logs')
